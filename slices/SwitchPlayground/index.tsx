  ...
  return (
    ...
    >
           <FadeIn> 
            ...
            <div className="mb-6 max-w-6xl text-xl text-pretty">
...
const SharedCanvas =({color}: SharedCanvasProps)=>{
  ...
  const colorName = color.uid as "black" | "blue" | "red" | "brown"
  ...
  return (
    ...
    <button onClick={handleSound} className="font-bold-slanted absolute bottom-0 left-0 z-10 flex items-center gap-3 p-6 text-4xl text-white uppercase focus:ring-2 focus:ring-2-white focus:outline-none">
      {name} <LuVolume2/>
      </button>
