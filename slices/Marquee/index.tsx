...
const MarqueeContent = () => (
      ...
      {slice.primary.phrases.map((item, i) => (
        ...
        <div className="text-[180px] md:text-[260px] font-bold-slanted px-14 text-gray-400/80 leading-none uppercase md:text-[260px][text-box:trim-both_cap_alphabetic]">{item.text}</div> 
