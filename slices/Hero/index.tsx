  ...
  useGSAP(() => {
    ...
    mm.add("(prefers-reduced-motion: no-preference)", ()=>{ 
      ...
      gsap.fromTo(".hero-scene", {
        background:"linear-gradient(to bottom, #000000, #0f172a, #062f4a, #062f4a)" ,
       
      }, {
        background:"linear-gradient(to bottom, #0f172a, #062f4a, #ffffff, #ffffff)" ,
         scrollTrigger: {
          trigger:".hero",
          start:"top top",
          end:"50% bottom",
...
<div className="hero-content absolute inset-x-0 top-0 h-dvh ">
  <Bounded fullWidth className="absolute inset-x-0 top-18 md:top-20 md:left-[6vw]">

    <PrismicRichText field={slice.primary.heading} components={{
      heading1: ({children}) => (
        <h1 className="hero-heading font-black-slanted text-6xl leanding-[0.8] uppercase sm:text-7xl lg:text-7xl">{children}</h1>
      )
    }} />
      </Bounded>
      ...
      <Bounded fullWidth 
      className="hero-body absolute
       bottom-0 opacity-0 inset-x-0 md:right-[6vw] md:left-auto"
    ...
    <PrismicRichText field={slice.primary.body} components={{
     ...
     <button className="font-bold-slanted flex w-fit cursor-pointer items-center gap-1 rounded bg-[#01A7E1] py-1 text-2xl uppercase transition disabled:grayscale group">
